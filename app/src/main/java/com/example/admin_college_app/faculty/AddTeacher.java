...
public class AddTeacher<items> extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] items = new String[]{"Select Category", "DIRECTOR", "MCA", "MBA", "Training and Placement", "Non Teaching", "Supporting Staff"};
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            filepath.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    insertData();
                                    pd.dismiss();
                                    Toast.makeText(AddTeacher.this, "Uploaded Successfully", Toast.LENGTH_SHORT).show();
                                }
                            });
                        }
                    });
